...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports Error]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
#set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { read }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
